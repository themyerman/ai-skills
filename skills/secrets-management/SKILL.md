...
- **Pairing** with [python-scripts-and-services / security.md](../python-scripts-and-services/security.md) (code-level) and [shift-left-security](../shift-left-security/SKILL.md) (org **handoff** context) for **tickets** / design review **redact** in text.
...
| **Threat model / formal** org **review** | [shift-left-security](../shift-left-security/SKILL.md) + your internal runbooks |
