...
- **Pair** with **[`code-review.md`](../python-internal-tools/code-review.md)** (Python **diff** quality) and your org's formal security intake process when **threat model** / **planning** applies.
...
| **`README.md` updated** | **Install**, **flags**, **config** paths, and **one** **known-good** command still work—see **[`documentation.md`](../python-internal-tools/documentation.md)** and **[`docs-clear-writing`](../docs-clear-writing/SKILL.md)**. |
...
| Topic | Where |
|--------|--------|
| **Secrets** in the **diff** / **history** | **[`secrets-management`](../secrets-management/SKILL.md)**; **CI** patterns in **[`secrets-scanning-ci.md`](../python-internal-tools/secrets-scanning-ci.md)** (Python repo). |
| **Repo ownership contact** | Keep repo contact metadata (e.g. owner, team Slack channel) accurate for security reachability. |
| **SAST / dependency / manual security pass** | **[`security-code-audit.md`](../python-internal-tools/security-code-audit.md)** + **[`security.md`](../python-internal-tools/security.md)**. |
| **Tests worth shipping** | **[`testing-strategy.md`](../python-internal-tools/testing-strategy.md)** (boundaries, **perf**, **flakiness**). |
| **HTTP APIs you own** | **[`api-http-service-design.md`](../python-internal-tools/api-http-service-design.md)**. |
| **Browser UI** (Jinja/**Flask**, templates, **`static/`**) | **[`web-frontend-basics`](../web-frontend-basics/SKILL.md)** · **[`flask-serving.md`](../python-internal-tools/flask-serving.md)**. |
...
- **Python merge review:** [`code-review.md`](../python-internal-tools/code-review.md)  
- **Where README / WORK / docs live:** [`documentation.md`](../python-internal-tools/documentation.md)  
