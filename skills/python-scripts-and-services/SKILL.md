...
| **[code-review.md](code-review.md)** | **PR / pre-merge** review: author + reviewer checklists, **blockers**, comment template; ties to [testing](testing-strategy.md), [security](security.md), [shift-left-security](../shift-left-security/SKILL.md) (org process context). |
...
| **[security.md](security.md)** | **Credentials**, HTTP session, **SQL/shell**, **boundary threat**; **formal** TM / program handoff → your org + [shift-left-security/](../shift-left-security/SKILL.md) (lightweight). |
| **[`shift-left-security/`](../shift-left-security/SKILL.md)** | **Thin** ideas: champions, **CI** defaults, when to **escalate**—**not** a full AppSec or GRC program. |
